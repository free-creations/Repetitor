...
/**
 * The AssocModel is a special ComboBoxModel
 * where every item is represented by a tuple of a number
...
class AssocModel extends DefaultComboBoxModel<String> {
   ...
   * @return the description corresponding to the given number.
   ...
   * @return the number corresponding to the given description.
   * Returns -1 if the description is unknown.
   */
   ...
   * @return the description of the currently selected item, or
   ...
   * @return the number of the currently selected item, or
