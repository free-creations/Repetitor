...
final class MediaFilesPanel extends javax.swing.JPanel {
   ...
   */
    ...
    private void initComponents() {
        ...
        mediaFloderPath = new javax.swing.JTextField();
        btnSelect = new javax.swing.JButton();

        mediaFloderPath.setText(org.openide.util.NbBundle.getMessage(MediaFilesPanel.class, "MediaFilesPanel.mediaFloderPath.text")); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(mediaFloderPath, javax.swing.GroupLayout.DEFAULT_SIZE, 313, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(mediaFloderPath, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
  ...
  private void btnSelectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelectActionPerformed
    ...
    if (returnVal == JFileChooser.APPROVE_OPTION) {
      ...
      mediaFloderPath.setText(file.getPath());
    }
  ...
  void load() {
    ...
    String mediaFolderPath = NbPreferences.forModule(MediaContainerExplorerTopComponent.class).
                     get(MediaContainerExplorerTopComponent.PREF_MEDIAFOLDER, 
                     System.getProperty("user.home") + "/RepetitorMedia");
    mediaFloderPath.setText(mediaFolderPath);
  ...
  void store() {
    ...
    NbPreferences.forModule(MediaContainerExplorerTopComponent.class).
            put(MediaContainerExplorerTopComponent.PREF_MEDIAFOLDER, mediaFloderPath.getText());
    
  }

  boolean valid() {
    File candidate = new File(mediaFloderPath.getText());
    if (!candidate.exists()) {
      return false;
    }
    ...
    private javax.swing.JTextField mediaFloderPath;
