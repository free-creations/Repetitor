...
/**
 * The audio-ports are the input-plugs into the {@link AudioMixer}. An audio
 * port permits to control and to query the sound volume on each channel.
 *
...
public interface AudioPort {
  ...
  /**
   * The maximum number of channels that are supported.
   */
   ...
   *
   * @param channel the audio channel (for a stereo port there are two channel,
   * left and right numbered 0 and 1).
   ...
   * The value is given in Decibel. A value of 0 indicates full value, a value
   * of 100 is full damping.
   *
   * @param channel the audio channel (for a stereo port there are two channel,
   * left and right numbered 0 and 1).
  ...
  /**
   * Set the value of the attenuation The attenuation indicates how the signal
   * of this port is damped. The value is given in Decibel. A value of 0
   * indicates full without value, a value of 120 is full damping. (Negative
